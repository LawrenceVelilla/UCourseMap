    ...
    <footer className={cn("py-6 px-6 border-t text-sm text-gray-600", className)}>
      <div className="container mx-auto flex flex-col items-center justify-center space-y-4">
        <div>
          ...
          <p>
            All rights reserved. This is a personal project and not affiliated with the University
            of Alberta. Data collected from the University of Alberta Course Catalogue.
          </p>
        </div>
