 ...
 */
function parseCourseString(
  courseString: string,
): { department: string; codeNumber: string } | null {
  ...
  async (departmentCode: string, courseCodeNumber: string): Promise<Course | null> => {
    ...
    try {
      ...
      const mappedCourse: Course = {
        ...
        units: dbCourse.units as Course["units"],
        keywords: dbCourse.keywords,
        requirements: dbCourse.requirements as RequirementsData,
